...
if selected_tickers:
    ...
    for ticker in selected_tickers:
        col1, col2, col3 = st.sidebar.columns([3, 5, 2])
        with col1:
            st.write(f"**{ticker}**")  # Display ticker on the left
            st.text_input(
                "%",
...
if selected_tickers:
    ...
    st.warning("Please enter at least one ticker to begin analysis")
